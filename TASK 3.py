...
#  	This program will:
# 					Show the day of the week that you visited per store for week 5 and 6
...
def getnumberweeksandhouses():
    ...
    filepath = "DATA CWK SHOPPING DATA WEEK 7 FILE B.csv"
    data_of_houses = readcsv(filepath)

    # This will check and confirm houses are in the file
    number_of_houses_confirmed = []

    # Changed to start at 2 due to the extra column added for task 3.
...
def dataofshoppinglist():
    ...
    filepath = "DATA CWK SHOPPING DATA WEEK 7 FILE A.csv"
